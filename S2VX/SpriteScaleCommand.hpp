...
namespace S2VX {
	...
	public:
		explicit SpriteScaleCommand(Sprite& sprite, const int start, const int end, const EasingType easing, const float pStartScaleX, const float pStartScaleY, const float pEndScaleX, const float pEndScaleY);
