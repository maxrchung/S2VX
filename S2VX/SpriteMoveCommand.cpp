...
#include "Sprite.hpp"
namespace S2VX {
	SpriteMoveCommand::SpriteMoveCommand(Sprite& sprite, const int start, const int end, const EasingType easing, const int pStartX, const int pStartY, const int pEndX, const int pEndY)
