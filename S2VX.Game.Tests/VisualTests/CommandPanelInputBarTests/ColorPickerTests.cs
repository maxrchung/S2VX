...
namespace S2VX.Game.Tests.VisualTests.CommandPanelInputBarTests {
    public class ColorPickerTests : S2VXTestScene {
        ...
        [Test]
        public void ShowColorPicker_NoColorCommand_DoesNotShowColorPicker() {
            InputManager.MoveMouseTo(InputBar.TxtStartValue);
            InputManager.Click();
            InputBar.StartColorPicker.Current.Value = Color4.Red;
            InputBar.StartColorPicker.Current.Value =
        }

        [Test]
        public void ShowColorPicker_ColorCommand_ShowsColorPicker() {
            InputManager.MoveMouseTo(InputBar.TxtStartValue);
            InputManager.Click();
            InputBar.StartColorPicker.Current.Value = Color4.Red;
            InputBar.StartColorPicker.Current.Value = 
        ...
        [Test]
        public void HideColorPicker_ColorCommand_HidesColorPicker() {
        }

        [Test]
        public void HandleSaveClick_RedStartColor_SavesCorrectColor() {

        }


        [Test]
        public void HandleSaveClick_GreenEndColor_SavesCorrectColor() {

        }

        [Test]
        public void HandleEditClick_BlueEndColor_SavesCorrectColor() {
